...
class PurposeController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            Toastr::success(\App\CentralLogics\translate('Successfully Added!'));
            return back();
        } catch (Exception $e) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            Toastr::success(\App\CentralLogics\translate('Successfully Updated!'));
        } catch (Exception $e) {
            Toastr::error(\App\CentralLogics\translate('failed!'));
        }
    ...
    public function delete(Request $request)
    {
        ...
        Toastr::success(\App\CentralLogics\translate('Successfully Deleted!'));
        return back();
    }
}
