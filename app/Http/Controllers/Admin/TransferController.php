...
class TransferController extends Controller
{
    public function index(Request $request)
    {
        ...
        $transfers = $transfers->latest()->paginate(Helpers::pagination_limit())->appends($query_param);
        return view('admin-views.transfer.index', compact('transfers', 'search'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($admin_transaction != null) {
                try {
                    DB::transaction(function () use ($request) {
                        ...
                        $transfer->receiver_type = $request->receiver_type;
            ...
            DB::rollBack();
            Toastr::error(\App\CentralLogics\translate('Failed!'));
            return back();
        }
        ...
        try {
            if ($value) {
                $data = [
                    'title' => \App\CentralLogics\translate('Transaction'),
                    'description' => $value,
                    'image' => '',
                    'order_id'=>'',
                ];
        ...
        Toastr::success(\App\CentralLogics\translate('Transferred Successfully!'));
        return back();
    }
...
//            ->whereNotNull(['f_name', 'l_name', 'phone'])
        ...
        $data[] = (object)['id' => false, 'text' => \App\CentralLogics\translate('Choose')];
