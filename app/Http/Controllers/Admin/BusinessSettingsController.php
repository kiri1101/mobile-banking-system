...
class BusinessSettingsController extends Controller
{
    ...
    public function business_setup(Request $request)
    {
        if (env('APP_MODE') == 'demo') {
            Toastr::info(\App\CentralLogics\translate('update_option_is_disable_for_demo'));
            return back();
        }
        ...
        Toastr::success(\App\CentralLogics\translate('successfully_updated_to_changes_restart_the_app'));
        return back();
    }
    ...
    public function payment_update(Request $request, $name)
    {
        ...
        Toastr::success(\App\CentralLogics\translate('payment settings updated!'));
        return back();
    }
    ...
    public function update_fcm(Request $request)
    {
        ...
        Toastr::success(\App\CentralLogics\translate('settings_updated'));
        return back();
    }
    ...
    public function update_fcm_messages(Request $request)
    {
        ...
        Toastr::success(\App\CentralLogics\translate('message_updated'));
        return back();
    }
    ...
    public function terms_and_conditions_update(Request $request)
    {
        ...
        Toastr::success(\App\CentralLogics\translate('Terms and Conditions updated!'));
        return back();
    }
    ...
    public function privacy_policy_update(Request $request)
    {
        ...
        Toastr::success(\App\CentralLogics\translate('Privacy policy updated!'));
        return back();
    }
    ...
    public function about_us_update(Request $request)
    {
        ...
        Toastr::success(\App\CentralLogics\translate('About us updated!'));
        return back();
    }
    ...
    public function linked_website_add(Request $request)
    {
        ...
        Toastr::success(\App\CentralLogics\translate('Added Successfully!'));
        return back();
    }
    ...
    public function linked_website_update(Request $request)
    {
        ...
        Toastr::success(\App\CentralLogics\translate('Updated Successfully!'));
        return back();
    }
    ...
    public function linked_website_delete(Request $request)
    {
        ...
        Toastr::success(\App\CentralLogics\translate('Website removed!'));
        return back();
    }
