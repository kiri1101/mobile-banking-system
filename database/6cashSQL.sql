...
(1, 'business_name', 'Forama Cameroun SARL', NULL, NULL),
...
INSERT INTO `e_money` (`id`, `user_id`, `current_balance`, `charge_earned`, `created_at`, `updated_at`) VALUES
(1, 1, 0.00, 0.00, '2022-05-26 10:50:16', '2022-05-26 10:50:16');
...
--
-- Table structure for table `cash_migrations`
--

CREATE TABLE `cash_migrations` (
...
--
-- Dumping data for table `cash_migrations`
--

INSERT INTO `cash_migrations` (`id`, `migration`, `batch`) VALUES
...
(2, NULL, 'Laravel Password Grant Client', 'UhJDtulOAo0vdfuaHCtQ4KT4QOiYDdmImM9x48Ax', 'cash_users', 'http://localhost', 0, 1, 0, '2022-04-07 08:03:44', '2022-04-07 08:03:44'),
...
(4, NULL, 'Laravel Password Grant Client', 'P03bw333WuSbG3KcWW0VYBBOOTAhcCZaCB3rTt3V', 'cash_users', 'http://localhost', 0, 1, 0, '2022-04-07 08:03:56', '2022-04-07 08:03:56');
...
--
-- Table structure for table `cash_password_resets`
--

CREATE TABLE `cash_password_resets` (
...
INSERT INTO `cash_users` (`id`, `f_name`, `l_name`, `phone`, `email`, `image`, `type`, `role`, `password`, `is_phone_verified`, `is_email_verified`, `remember_token`, `created_at`, `updated_at`, `last_active_at`, `unique_id`, `referral_id`, `gender`, `occupation`, `two_factor`, `fcm_token`, `is_active`) VALUES
(1, 'Tifack', 'Danny', '214556665', 'user@gmail.com', NULL, 0, NULL, '$2y$10$reJ/eyesNergQ1Pz9v8SUOU84NRi4PeW51BkFIUo/NR63vCi9FoQe', 1, 0, NULL, '2022-05-26 10:50:16', '2022-05-26 10:50:16', NULL, NULL, NULL, NULL, NULL, 0, NULL, 1);
...
--
-- Indexes for table `cash_migrations`
--
ALTER TABLE `cash_migrations`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `cash_password_resets`
--
ALTER TABLE `cash_password_resets`
...
--
-- Indexes for table `cash_users`
--
ALTER TABLE `cash_users`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `cash_migrations`
--
ALTER TABLE `cash_migrations`
...
--
-- AUTO_INCREMENT for table `cash_users`
--
ALTER TABLE `cash_users`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
